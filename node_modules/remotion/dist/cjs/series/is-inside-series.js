...
const IsInsideSeriesContainer = ({ children }) => {
    return (jsx_runtime_1.jsx(exports.IsInsideSeriesContext.Provider, { value: true, children: children }));
};
exports.IsInsideSeriesContainer = IsInsideSeriesContainer;
const IsNotInsideSeriesProvider = ({ children }) => {
    return (jsx_runtime_1.jsx(exports.IsInsideSeriesContext.Provider, { value: false, children: children }));
};
